...
class MySQLConceptResolver:
    ...
    def resolve(
        ...
        *,
        ...
        search_conds, search_bindings = build_where_conditions([], [text], medcat_expansions, syn_concept_ids)
        if not search_conds:
            return []

        score_sql, score_bindings = build_score_sql([text], medcat_expansions, [], syn_concept_ids)
